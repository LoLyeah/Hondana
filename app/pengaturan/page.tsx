...
export default function Pengaturan() {
  ...
  const handleFullReset = () => {
    if (window.confirm('APAKAH ANDA YAKIN? Tindakan ini akan menghapus SELURUH data aplikasi Hondana (statistik, riwayat, sesi aktif, cache soal AI, dan pengaturan) dari browser ini. Halaman akan dimuat ulang.\n\nSelesaikan jika Anda mengalami masalah/error.')) {
      try {
  ...
  return (
    <>
      ...
      >
        {/* Settings Group: PWA Install (Repositioned to top and highlighted) */}
        <motion.section 
