...
try {
  ...
  console.log('\n[Version Hook] Success! Version bumped and pushed.');
  console.log('[Version Hook] Note: The git warning "error: failed to push some refs" below is normal and safe to ignore.\n');
  process.exit(1);
} catch (e) {
