...
export default function Header({ title, showBack = false, onBack, noSidebar = false, rightElement }: HeaderProps) {
  ...
  return (
    <header
      className="sticky top-0 z-40 w-full glass border-b border-white/8 backdrop-blur-md"
      style={{ paddingTop: 'calc(12px + env(safe-area-inset-top, 0px))', paddingBottom: '12px' }}
    >
      <div className={`w-full max-w-content-max mx-auto px-4 ${noSidebar ? '' : 'md:pl-sidebar!'} flex items-center justify-between`}>
